...
//    m_str3.replace(",",".");
    ...
    std::vector<std::string> args={"carlepremierargesttoujorsleprog","-in","serial://ttyACM0:115200:8:n:1:#ubx","-out","serial://ttyUSB0:57600:8:n:1:#rtcm3","-msg","1004,1019,1012,1020,1006,1008","-p",latstr,lonstr,hstr};
