...

{
  ...
  if (PositionMode==2){filenamebase = "sauvegardepourbaseManual.txt";}
    ...
    std::vector<std::string> args={"carlepremierargesttoujorsleprog","-in","serial://ttyACM0:115200:8:n:1:#ubx","-out","serial://ttyUSB0:38400:8:n:1:#rtcm3","-p",latstr,lonstr,hstr,"-msg","1004,1019,1012,1020,1006,1008",};
