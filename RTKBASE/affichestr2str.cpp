    ...
    ui(new Ui::AfficheStr2str)
{
    ...
    else if (PositionMode = 2){filenamebase = "sauvegardepourbaseManual.txt";}
    }
...
void AfficheStr2str::recupdonneesStr2str(QStringList i)
{
    ...
    ui->Msg1lineEdit->setText(QString("Real Position picked up from rover mode"));
    ui->Msg2lineEdit->setText(QString("Lat = %1 deg Lon = %2 deg H= %3 m").arg(m_str1).arg(m_str2).arg(m_str3));
