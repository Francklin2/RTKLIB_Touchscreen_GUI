...
void OptionsStr2str::on_radioButtonPositionAuto_toggled(bool checked)
{
  PositionMode = 1;
}
...
void OptionsStr2str::on_radioButtonPositionManual_toggled(bool checked)
{


     if(this->ui->radioButtonPositionManual->isChecked())
{
  PositionMode = 2;
}
