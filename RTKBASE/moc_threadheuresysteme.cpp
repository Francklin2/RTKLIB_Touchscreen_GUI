...
struct qt_meta_stringdata_ThreadHeureSysteme_t {
    QByteArrayData data[3];
    char stringdata0[35];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ThreadHeureSysteme_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ThreadHeureSysteme_t qt_meta_stringdata_ThreadHeureSysteme = {
    {
QT_MOC_LITERAL(0, 0, 18), // "ThreadHeureSysteme"
QT_MOC_LITERAL(1, 19, 14), // "heureretournee"
QT_MOC_LITERAL(2, 34, 0) // ""

    },
    "ThreadHeureSysteme\0heureretournee\0"
};
...
void ThreadHeureSysteme::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ThreadHeureSysteme::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ThreadHeureSysteme::heureretournee)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject ThreadHeureSysteme::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ThreadHeureSysteme.data,
      qt_meta_data_ThreadHeureSysteme,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ThreadHeureSysteme::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ThreadHeureSysteme.stringdata0))
