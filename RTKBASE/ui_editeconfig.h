...
""));
        ...
        ReconnectBox->setGeometry(QRect(610, 120, 150, 40));
        ...
        label_86->setGeometry(QRect(410, 120, 190, 40));
        label_87 = new QLabel(MiscTab);
        label_87->setObjectName(QStringLiteral("label_87"));
        label_87->setGeometry(QRect(410, 60, 201, 40));
        BuffsizeBox = new MyComboBox(MiscTab);
        BuffsizeBox->setObjectName(QStringLiteral("BuffsizeBox"));
        BuffsizeBox->setGeometry(QRect(610, 60, 150, 40));
        ...
        FswapmarginBox->setGeometry(QRect(610, 180, 150, 40));
        ...
        label_89->setGeometry(QRect(20, 240, 211, 40));
        label_90 = new QLabel(MiscTab);
        label_90->setObjectName(QStringLiteral("label_90"));
        label_90->setGeometry(QRect(410, 240, 131, 40));
        ProxyadrBox = new MyLineEdit(MiscTab);
        ProxyadrBox->setObjectName(QStringLiteral("ProxyadrBox"));
        ProxyadrBox->setGeometry(QRect(550, 240, 211, 41));
        SbasatselBox = new MyLineEdit(MiscTab);
        SbasatselBox->setObjectName(QStringLiteral("SbasatselBox"));
        SbasatselBox->setGeometry(QRect(270, 300, 491, 41));
        label_91 = new QLabel(MiscTab);
        label_91->setObjectName(QStringLiteral("label_91"));
        label_91->setGeometry(QRect(20, 300, 221, 40));
        label_118 = new QLabel(MiscTab);
        label_118->setObjectName(QStringLiteral("label_118"));
        label_118->setGeometry(QRect(20, 10, 190, 40));
        NMEAreq = new MyComboBox(MiscTab);
        NMEAreq->setObjectName(QStringLiteral("NMEAreq"));
        NMEAreq->setGeometry(QRect(220, 10, 101, 40));
        NMEAreq->setEditable(true);
        NMEAreq->setFrame(true);
...
"background-color: rgb(230, 230, 230);"));
    ...
    void retranslateUi(QDialog *EditeConfig)
    {
        ...
        label_118->setText(QApplication::translate("EditeConfig", "NMEA required", 0));
        NMEAreq->clear();
        NMEAreq->insertItems(0, QStringList()
         << QApplication::translate("EditeConfig", "off", 0)
         << QApplication::translate("EditeConfig", "llh", 0)
         << QApplication::translate("EditeConfig", "single", 0)
        );
