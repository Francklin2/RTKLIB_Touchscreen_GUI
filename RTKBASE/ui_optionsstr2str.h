...
""));
    ...
    void retranslateUi(QDialog *OptionsStr2str)
    {
        ...
        OutSerialPortcomboBox->insertItems(0, QStringList()
         ...
         << QApplication::translate("OptionsStr2str", "ntrips://", 0)
        );
        ...
        lineEdit_18->setText(QApplication::translate("OptionsStr2str", "STRING FOR NTRIP SERVER", 0));
        OutServerPathcomboBox->clear();
        OutServerPathcomboBox->insertItems(0, QStringList()
         << QApplication::translate("OptionsStr2str", ":BETATEST@rtk2go.com:2101/Myplace#rtcm3", 0)
        );
